...
// breadcrumb, badge (vinho) + metadados, título grande e lead serifado.
      ...
      <div className="relative mx-auto max-w-6xl px-6 py-16">
        ...
        {(badge || meta) && (
          <div className="mb-5 flex flex-wrap items-center gap-3 text-sm text-muted">
            {badge && (
              <span className="rounded-full border border-wine/30 bg-wine/5 px-3 py-1 text-[0.68rem] font-semibold uppercase tracking-wider text-wine">
                {badge}
              </span>
            )}
            {meta}
